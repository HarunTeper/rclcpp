...
.PHONY: lyrical-build lyrical-shell lyrical-test humble-build humble-shell jazzy-build jazzy-shell
lyrical-build:
...
.PHONY: compare-lyrical compare-jazzy autoware-build autoware-smoke autoware-shell \
